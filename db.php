<?php 
    ...
    $products = array(
        ...
        8.5, 1200, 'Sterilised'),
        new Toy('Carotina', 7.99 , 'dog', 'https://m.media-amazon.com/images/I/61qMwHJ+PvL._AC_SY300_SX300_.jpg', 'Peluche', 'CarotinaKeCarina', 'Chewy'),
        new Human('Jerry', 'Trapped','Lawyer', 'Green')
    );
?>
